...
import numpy as np
from inception import ops
import tensorflow as tf
from inception import variables
from inception.scopes import arg_scope
    ...
    for i in xrange(FLAGS.num_gpus):
      with tf.device('/gpu:%d' % i):
        with tf.name_scope('%s_%d' % (model.TOWER_NAME, i)) as scope:
          ...
          batchnorm_updates = tf.get_collection(ops.UPDATE_OPS_COLLECTION,
                                                scope)
